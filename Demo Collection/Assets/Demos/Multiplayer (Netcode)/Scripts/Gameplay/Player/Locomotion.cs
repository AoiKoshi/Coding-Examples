    ...
    public class Locomotion : NetworkBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (IsOwner)
            {
                ...
                Anim.SetFloat("MoveY", Inputs.InputDir.magnitude);
            }
        }
        ...
        private void Movement()
        {
            ...
            if (Time.time - lastGroundedTime <= jumpGracePeriod)
            {
                ...
                RBody.velocity = currentYVelocity + moveDir * movementSpeed * slopeModifier;
            }
            else if (!isGrounded && airTime > 0.5f)
            {
                RBody.velocity = currentYVelocity + moveDir * movementSpeed;
            }
